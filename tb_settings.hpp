class ICE
{
	...
	class mission
	{
		...
		class factions // or sides
		{
			...
			class teamName
			{
				bluFor = "PMC - Blackwater";
				opFor = "Russia - Spetsnaz";
			};
			class teamFlag
			{
				bluFor = "flags\Blackwater.paa";
			};
		};
		class scoring
		{
	...
	class gameModes
	{
	    class objectives
        {
            class zones
            {
                class captureRates
                {
                    heldZoneMultiplier = 1.25; // Decimal value between 0 and N - <1 reduces capture rate, >1 increases capture rate
					neutralZoneMultiplier = 2.0; // This is a cumulative multiplier with 'heldZoneMultiplier'
