class cfgMagazines
{
	class magazineLimitations
	{
		...
		class 40mm_HE
		{
			magazineArray[] = {"rhs_mag_M441_HE", "rhs_mag_M397_HET", "rhs_mag_M433_HEDP", "rhs_VOG25", "rhs_VOG25P", "rhs_VG40TB", "CUP_1Rnd_HE_M203", "CUP_1Rnd_HEDP_M203"};
			limit = 8;
			limtResistance = 8;
		...
		class Grenade
		{
			magazineArray[] = {"rhs_mag_rgd5", "rhs_mag_m67", "rhsgref_mag_rkg3em", "rhs_mag_rgn", "rhs_mag_rgo"};
			limit = 2;
			limtResistance = 2;
		...
		class MAT_Rockets
		{
			magazineArray[] = {"rhs_rpg7_PG7VL_mag", "rhs_rpg7_PG7V_mag", "rhs_rpg7_TBG7V_mag", "rhs_rpg7_PG7VR_mag", "rhs_rpg7_OG7V_mag", "CUP_MAAWS_HEAT_M", "CUP_MAAWS_HEDP_M", "CUP_SMAW_HEAA_M_N", "CUP_SMAW_HEDP_M_N", "CUP_PG7V_M", "CUP_PG7VL_M", "CUP_PG7VR_M", "CUP_OG7_M", "RPG32_F", "RPG32_HE_F"};
			limit = 3;
			limtResistance = 3;
